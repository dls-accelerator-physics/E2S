...
harmB.h_or_v = 'v' # magnetic field plane: horizontal ('h') or vertical ('v')
...
strIntOutFileNamePartCoh = outfil+'_res_int_part_coh1.dat' #'ex08_res_int_part_coh1.dat' # file name for output SR intensity data
...
nMacroElec = Nelectr #total number of macro-electrons
