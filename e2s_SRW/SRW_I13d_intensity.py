...
strIntOutFileName3 = 'multi-e__'+outfil+'__'+lattice+'_'+timestamp+'.dat' #'ex08_res_int3.dat' #file name for output SR intensity data
...
wfr2.mesh.xStart =  meshXsta*1e-6 # -0.00025  # -0.0015 #Initial Horizontal Position [m]
wfr2.mesh.xFin =    meshXfin*1e-6 #0.00025  # 0.0015 #Final Horizontal Position [m]
wfr2.mesh.yStart =  meshYsta*1e-6 #  # -0.0006 #Initial Vertical Position [m]
wfr2.mesh.yFin   =  meshYfin*1e-6 #0.00025  # 0.0006 #Final Vertical Position [m]
